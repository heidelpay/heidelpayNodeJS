...
export const URL_PAYMENT_CHARGE = '/payments/charges'
export const URL_PAYMENT_CHARGE_AUTHORIZE = '/payments/{paymentId}/charges'
export const URL_PAYMENT_CHARGE_CANCEL = '/payments/{paymentId}/charges/{chargeId}/cancels'
